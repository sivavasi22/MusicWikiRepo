...
interface AlbumDetailsApiService {
    ...
    @GET("/2.0/")
    fun albumservice(@Query("artist") artist:String,@Query("album") album:String): Call<AlbumDataDetailsRequest>

    companion object {
        val instance: AlbumDetailsApiService by lazy {
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(AlbumDetailsApiService::class.java)
